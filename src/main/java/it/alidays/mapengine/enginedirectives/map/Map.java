...
public class Map {
	...
	private String aggregatorFactory;
	private List<Retrieve> retrieves;
	
	@XmlAttribute(name = "map-package", required = true)
	...
	@XmlAttribute(name = "aggregator-factory", required = true)
	public String getAggregatorFactory() {
		return this.aggregatorFactory;
	}

	public void setAggregatorFactory(String aggregatorFactory) {
		this.aggregatorFactory = aggregatorFactory;
	}

	@XmlElement(name = "retrieve", required = true)
	public List<Retrieve> getRetrieves() {
		return this.retrieves;
	}

	public void setRetrieves(List<Retrieve> retrieves) {
